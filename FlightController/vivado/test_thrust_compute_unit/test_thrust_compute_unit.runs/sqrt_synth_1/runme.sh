...
HD_PWD='G:/workspace/Drone/FlightController/vivado/test_thrust_compute_unit/test_thrust_compute_unit.runs/sqrt_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sqrt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sqrt.tcl
